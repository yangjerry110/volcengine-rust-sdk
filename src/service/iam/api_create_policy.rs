 ...
 * @LastEditTime: 2024-11-06 11:03:44
...
/**
 * @description: ApiCreatePolicyIam
 * @author: Jerry.Yang
...
impl ApiCreatePolicyIam {
    ...
    ///
    /// # 返回
    /// 成功返回 iam_policy::CreatePolicyResp, 错误返回 error::Error
    ...
    async fn new_create_policy_request(
        ...
        let api_response = response
            .json::<volcengine_sdk_protobuf::protobuf::iam_policy::CreatePolicyResp>()
            .await
