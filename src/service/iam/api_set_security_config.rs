 ...
 * @LastEditTime: 2024-10-30 11:28:57
...
/**
 * @description: ApiSetSecurityConfigIam
 * @author: Jerry.Yang
...
impl ApiSetSecurityConfigIam {
    ...
    ///
    /// # 参数
    /// 成功返回 iam_user::SetSecurityConfigResp, 错误返回 error::Error
    ...
    /// new_set_security_config_request
    ///
    /// # 参数
    /// - `&self`
    /// - `iam` : &Iam
