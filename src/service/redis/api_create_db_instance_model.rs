 ...
 * @LastEditTime: 2024-11-07 10:47:56
 * @Description: api describe vpcs model
 */
...
impl request::ApiRequest for redis_instance::CreateDbInstanceReq {
...
impl response::ApiResponse for redis_instance::CreateDbInstanceResp {
    async fn to_struct(&mut self, http_response: reqwest::Response) -> Result<(), error::Error> {
        // 解析 JSON 响应体
        let parsed_response: volcengine_sdk_protobuf::protobuf::redis_instance::CreateDbInstanceResp =
            http_response
                .json()
                .await
